...
See [tools-config/local_mcp_example.yml](tools-config/local_mcp_example.yml) and [tools-config/drupal_mcp.yml](tools-config/drupal_mcp.yml) for complete examples.
